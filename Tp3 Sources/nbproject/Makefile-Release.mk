...
${OBJECTDIR}/CompteAbsentException.o: CompteAbsentException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CompteAbsentException.o CompteAbsentException.cpp

${OBJECTDIR}/CompteDejaPresentException.o: CompteDejaPresentException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CompteDejaPresentException.o CompteDejaPresentException.cpp
...
${TESTDIR}/ChequeTesteur.o: ChequeTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/ChequeTesteur.o ChequeTesteur.cpp


${TESTDIR}/ClientTesteur.o: ClientTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/ClientTesteur.o ClientTesteur.cpp


${TESTDIR}/CompteTesteur.o: CompteTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/CompteTesteur.o CompteTesteur.cpp


${TESTDIR}/DateTesteur.o: DateTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/DateTesteur.o DateTesteur.cpp


${TESTDIR}/EpargneTesteur.o: EpargneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/EpargneTesteur.o EpargneTesteur.cpp
...
${OBJECTDIR}/CompteAbsentException_nomain.o: ${OBJECTDIR}/CompteAbsentException.o CompteAbsentException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CompteAbsentException_nomain.o CompteAbsentException.cpp;\
	else  \
...
${OBJECTDIR}/CompteDejaPresentException_nomain.o: ${OBJECTDIR}/CompteDejaPresentException.o CompteDejaPresentException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CompteDejaPresentException_nomain.o CompteDejaPresentException.cpp;\
	else  \
